...
| Type | Entité | Topic état | Topic commande |
|------|--------|-----------|----------------|
| Sensor | Température | `{base}/temperature` | — |
| Sensor | pH | `{base}/ph` | — |
| Sensor | ORP | `{base}/orp` | — |
...
| Binary Sensor | Statut contrôleur | `{base}/status` | — |
| Select | Mode filtration | `{base}/filtration_mode` | `{base}/filtration_mode/set` |
| Switch | Filtration ON/OFF | `{base}/filtration_state` | `{base}/filtration/set` |
| Switch | Éclairage ON/OFF | `{base}/lighting_state` | `{base}/lighting/set` |
